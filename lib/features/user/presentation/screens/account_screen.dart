...
import '../../../../core/widgets/editable_field.dart';
...
import '../../domain/usecases/set_custom_goal_usecase.dart';
...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Future<void> _saveName() async {
    ...
    await register(name, userRepo.currentUser!.weight);
    if (!mounted) return;
  ...
  Future<void> _saveGoal() async {
    ...
    final setGoal = getIt<SetCustomGoalUsecase>();
    await setGoal(goal);
    if (!mounted) return;
              ...
              Row(
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      await getIt<SetCustomGoalUsecase>()(null);
