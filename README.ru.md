...
## Скриншоты
**Для русских пользователей интерфейс приложения будет на русском языке, не переживайте!😺**
...
- Беспарольная аутентификация через ссылку, которая приходит на почту, или мгновенная анонимный доступ
